...
[![Version 1.1.0](https://img.shields.io/badge/version-1.1.0-blue)](https://github.com/Wenshuishi0528/ScreenCrossRuler/releases/latest)
...
1. 从 [Releases](https://github.com/Wenshuishi0528/ScreenCrossRuler/releases/latest) 下载 `ScreenCrossRuler-1.1.0-macOS-universal.zip`。
...
- Transparent center toggle, on by default.
...
1. Download `ScreenCrossRuler-1.1.0-macOS-universal.zip` from [Releases](https://github.com/Wenshuishi0528/ScreenCrossRuler/releases/latest).
